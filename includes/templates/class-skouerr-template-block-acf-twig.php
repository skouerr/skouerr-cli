...
/**
 * Skouerr_Template_Block_Acf_Twig class extends Skouerr_Template_Block
 * to handle the creation of ACF (Advanced Custom Fields) blocks using
 * Twig templates. This class manages the setup of block files such as
 * controller, Twig template, block.json, style, and script files, renaming
 * them and moving them into the correct folders.
 */
class Skouerr_Template_Block_Acf_Twig extends Skouerr_Template_Block {
	 ...
	 * - Renames important files (controller, Twig template, block, style, script)
