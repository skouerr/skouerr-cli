...
/**
 * Skouerr_Template_Block_Native_Twig class extends Skouerr_Template_Block
 * to handle the creation of native blocks using Twig templates.
 * This class manages the setup of block files such as controller,
 * Twig template, block.json, style, script, and register files,
 * renaming them and moving them into the correct folders.
 */
class Skouerr_Template_Block_Native_Twig extends Skouerr_Template_Block
{
     ...
     * - Renames important files (controller, Twig template, block, style, script, register)
